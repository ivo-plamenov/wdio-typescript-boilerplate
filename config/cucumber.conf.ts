...
const config: WebdriverIO.Config  = {
    ...
    // },
    //
    // Folder where the framework logs will be stored.
    outputDir: './logs',
    //
    ...
    afterSuite: function (suite) {
        log.debug(`Suite "${suite.fullTitle}" from file "${suite.file}" finished`);
    },
    /**
